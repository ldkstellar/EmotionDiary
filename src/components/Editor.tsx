    ...
    return(
        <div className="Editor">
            <section className="date_section">
                <h4>오늘의 날짜</h4>
                <input name="createdDate" type="date" value={getStringedDate(input.date)} onChange={onChangeInput}/>
            </section>

            <section className="emotion_section">
                <h4>오늘의 감정</h4>
                <div className="emotion_list_wrapper">
                    {EmotionList.map((e)=><EmotionItem onClick={()=>{
                        onChangeInput({
                            target:{
                                name:"emotionId",
                                value:e.emotionId,
                    ...
                    }} key={e.emotionId} {...e} isSelected={e.emotionId === input.id}/>)}
                </div>
